...
import com.blockchain.swap.nabu.api.CurrencyRatio
import com.blockchain.swap.nabu.api.PeriodicLimit
import com.blockchain.swap.nabu.api.QuoteJson
import com.blockchain.swap.nabu.api.TradeRequest
import com.blockchain.swap.nabu.api.TradesLimits
import com.blockchain.swap.nabu.api.TradingConfig
...
"""
    ...
    fun `mock server lacks ways to ensure headers were set, so at least verify authenticate was called`() {
        ...
        verify(get<Authenticator>())
            .authenticate<com.blockchain.swap.nabu.service.TradingConfig>(any())
    }
