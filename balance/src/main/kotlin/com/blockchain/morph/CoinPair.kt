...
enum class CoinPair(
    ...
    BTC_TO_ALG("btc_algo", CryptoCurrency.BTC, CryptoCurrency.ALG),
    ...
    ETH_TO_ALG("eth_algo", CryptoCurrency.ETHER, CryptoCurrency.ALG),
    ...
    BCH_TO_ALG("bch_algo", CryptoCurrency.BCH, CryptoCurrency.ALG),
    ...
    XLM_TO_ALG("xlm_algo", CryptoCurrency.XLM, CryptoCurrency.ALG),
    ...
    PAX_TO_ALG("pax_algo", CryptoCurrency.PAX, CryptoCurrency.ALG),

    ALG_TO_ALG("algo_algo", CryptoCurrency.ALG, CryptoCurrency.ALG),
    ALG_TO_BTC("algo_btc", CryptoCurrency.ALG, CryptoCurrency.BTC),
    ALG_TO_ETH("algo_eth", CryptoCurrency.ALG, CryptoCurrency.ETHER),
    ALG_TO_BCH("algo_bch", CryptoCurrency.ALG, CryptoCurrency.BCH),
    ALG_TO_XLM("algo_xlm", CryptoCurrency.ALG, CryptoCurrency.XLM),
    ALG_TO_PAX("algo_pax", CryptoCurrency.ALG, CryptoCurrency.PAX) ;
