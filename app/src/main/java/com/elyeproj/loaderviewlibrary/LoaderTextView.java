...
public class LoaderTextView extends AppCompatTextView implements LoaderView {
    ...
    private void init(AttributeSet attrs) {
        ...
        defaultColorResource = typedArray.getColor(R.styleable.loader_view_custom_color, ContextCompat.getColor(getContext(), R.color.loader_default_color));
        darkerColorResource = typedArray.getColor(R.styleable.loader_view_custom_color, ContextCompat.getColor(getContext(), R.color.loader_darker_color));
        typedArray.recycle();
    }
