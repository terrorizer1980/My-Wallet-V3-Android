 ...
 *
 * A simple class to ease the creation of consumable bitcoin links. Should probably be expanded in
 * the future to allow the encoding of messages, labels and other extras.
 */
