...
internal class UsdtCryptoWalletAccount(
    ...
    override val cryptoCurrencies = setOf(CryptoCurrency.USDT)

    override val balance: Single<CryptoValue>
        get() = usdtAccount.getBalance()
    ...
    override val activity: Single<ActivitySummaryList>
        get() {
            val ethDataManager = usdtAccount.ethDataManager

            val feedTransactions =
                usdtAccount.fetchErc20Address()
                    .flatMap { usdtAccount.getTransactions() }
                    .mapList {
