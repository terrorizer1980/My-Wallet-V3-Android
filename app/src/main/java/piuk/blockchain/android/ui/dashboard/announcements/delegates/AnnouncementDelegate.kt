...
import piuk.blockchain.android.ui.dashboard.announcements.PitAnnouncementCard
...
class PitAnnouncementDelegate<in T> : AnnouncementDelegate<T>() {
    override fun isForViewType(items: List<T>, position: Int) = items[position] is PitAnnouncementCard
