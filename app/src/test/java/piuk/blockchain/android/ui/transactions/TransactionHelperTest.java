...
class TestActivitySummaryItem extends ActivitySummaryItem {

    public CryptoCurrency getCryptoCurrency() { return CryptoCurrency.BTC; }
    public long getTimeStamp() { return 0; }
    public TransactionSummary.Direction getDirection() { return TransactionSummary.Direction.RECEIVED; }
    public BigInteger getTotal() { return new BigInteger("0"); }
    public Observable<BigInteger> getFee() { return Observable.just(new BigInteger("0")); }
    public String getHash() { return ""; }
    public Map<String, BigInteger> getInputsMap() { return new HashMap<>(); }
    public Map<String, BigInteger> getOutputsMap() { return new HashMap<>(); }
}
