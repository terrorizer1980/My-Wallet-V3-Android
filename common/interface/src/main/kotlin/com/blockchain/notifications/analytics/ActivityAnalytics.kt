...
enum class ActivityAnalytics (override val event: String, override val params: Map<String, String> = emptyMap()): AnalyticsEvent {
    ACTIVITY_SHOWN("activity_page_shown"),
